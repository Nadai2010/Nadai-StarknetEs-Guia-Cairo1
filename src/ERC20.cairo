...
mod ERC20 {
    ...
    #[constructor]
    fn constructor(
        nombre: felt252, symbol: felt252, initial_supply: u256, recipient: ContractAddress
    ) {
        initializer(nombre, symbol);
    ...
    #[internal]
    fn initializer(nombre_: felt252, symbol_: felt252) {
        _nombre::write(nombre_);
